...
import {FaCcVisa,FaAmazon,FaIdCard,FaCcMastercard,FaCcPaypal,FaCcStripe,FaGoogleWallet,FaCcDiscover} from 'react-icons/fa'
function Aces4() {
    let [number, setNumber] = useState(1);
    let [prix, setPrix] = useState(9.99);
    const plus = () => {
        setNumber(
            number = number + 1,
        )
    ...
    return (
        ...
        <div className="container SWIT body-2 bg-dark row">
            <div className="col-6 text-white ">
                    <img src="/pectures/cable-original.jpg" className=" image2" height={"320px"}/>
                <Link to='/' className="link-icons" id="link-ic"><AiOutlineArrowLeft className="icons"/></Link>
            </div>
            <div className="col-6 text-white">
                <div className="ps-5 pt-5">
                    <h3 className="gamer-titre">Micro-phone</h3>
                    <div className="ps-3">
                        <p className="ps-3">
                        Le câble de charge de 1,82 m (lot de 2) permet de jouer <br/>
                        à la PlayStation 4 tout en chargeant simultanément une manette <br/>
                        de PS4 - Connecteurs micro-USB vers USB de type A.<br/>
                        Temps de charge total de 1,5 à 2 h en chargeant<br/>
                        à partir d'un port USB de console PS4. <br/>
                        </p>
                        <br />
