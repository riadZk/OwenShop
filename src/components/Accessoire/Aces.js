    ...
    return (
        ...
        <div className="container SWIT body-2 bg-dark row">
            <div className="col-6 text-white ">
                        <img src="/pectures/skin-play.jpg" className=" image2" height={"320px"} />
                    <Link to='/' className="link-icons" id="link-ic"><AiOutlineArrowLeft className="icons"/></Link>
            </div>
            <div className="col-6 text-white">
                <div className="ps-5 pt-5">
                    <h3 className="gamer-titre">Skin PlayStation</h3>
                    <div className="ps-3">
                        <span className="span">Brand</span> : XSUID<br />
                        <span className="span">Color</span> : blue<br />
                        <span className="span">Compatible Devices</span> :  Controller<br />
                        <span className="span">Theme</span> : Anime<br />
                        <span className="span">Pattern</span> : Anime<br />
                        <br />
