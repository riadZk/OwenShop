    ...
    return (
        ...
        <div className="container SWIT body-2 bg-dark row">
            <div className="col-6 text-white ">
                    <img src="/pectures/casque-gamer.jpg" className=" image2" height={"320px"}/>
                    <Link to='/' className="link-icons" id="link-ic"><AiOutlineArrowLeft className="icons"/></Link>
            </div>
            <div className="col-6 text-white">
                <div className="ps-5 pt-5">
                    <h3 className="gamer-titre">Casque-Gamer</h3>
                    <div className="ps-3">

                        <span className="span">Port confortable</span> : serre-tête adapté à tous les joueurs<br />
                        ...
                        <span className="span">WATERCOOLER</span> : MSI MEG CORELIQUID S360<br />
                         <span className="span">Microphone</span> : Microphone flexible et rétractable<br />
                        <span className="span">Poids</span> : 430 g<br />
                        <br />
