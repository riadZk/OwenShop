    ...
    return (
        ...
        <div className="container SWIT body-2 bg-dark row">
            <div className="col-6 text-white ">
                    <img src="/pectures/micro.jpg" className=" image2" height={"320px"}/>
            ...
            <div className="col-6 text-white">
                <div className="ps-5 pt-5">
                    ...
                    <div className="ps-3">
                        <p className="ps-3">
                        Microphone Gaming ultra-compact<br/>
                    Support inclinable<br/>
                    Mode de captation supercardioïde pour réduire les bruits de fond<br/>
                    Antichoc pour absorber les vibrations<br/>
                    Micro électrostatique conçu pour la diffusion<br/>
                        </p>
                        <br />
