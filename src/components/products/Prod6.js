    ...
    return (
        ...
        <div className="container body-2 bg-dark row">
            <div className="col-6 text-white ">
                    <img src="/pectures/Chaise-gaming.jpg" className=" image2" width={"400px"} />
            ...
            <div className="col-6 text-white">
                <div className="ps-5 pt-5">
                    ...
                    <div className="ps-3">
                    [Racing Style] This gaming chair is wrapped in all black leather and carbon-fiber in a sleek, race-inspired shape, providing immersive gaming experience.
                    [Comfort Design] Ergonomic design helps you maintain a neutral, balanced posture and reduce your pressure and pain. Well-padded seat, lumbar & headrest cushions make extended gaming sessions more enjoyable.
                        <br />
                        <br />
