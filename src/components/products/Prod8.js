    ...
    return (
        ...
        <div className="container SWIT body-2 bg-dark row">
            <div className="col-6 text-white ">
                    <img src="/pectures/bureau-gamer.jpg" className=" image2" width={"400px"} />
                    <Link to='/' className="link-icons" id="link-ic"><AiOutlineArrowLeft className="icons"/></Link>
            </div>
            <div className="col-6 text-white">
                <div className="ps-5 pt-5">
                    <h3 className="gamer-titre">Bureau-Gaming</h3>
                    <div className="ps-3">
                    Easy to clean and take care of
                    Scientifically designed to fit the body without hindrance
                    Use occasion:home,office,Internet cafe
                    This double-layer design can help you better organize items on your computer desk.<br />
                        <br />
