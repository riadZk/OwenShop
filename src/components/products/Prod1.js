    ...
    return (
        ...
        <div className="container body-2 bg-dark row">
            <div className="col-6 text-white ">
                    <img src="/pectures/PS5.png" className=" image2"  />
                    <Link to='/' className="link-icons" id="link-ic"><AiOutlineArrowLeft className="icons"/></Link>
            </div>
            <div className="col-6 text-white">
                <div className="ps-5 pt-5">
                    <h3 className="gamer-titre">Sony PS5 Console standard PlayStation inclus 2x manette</h3>
                    <div className="ps-3">
                        <span className="span">Capacité</span> : 825gb<br />
                        <span className="span">couleur</span> : Blanc<br />
                        <span className="span">inclus</span> :  2X Manette<br />
                        <span className="span">SKU</span> : SO298EC0N1VBKNAFAMZ<br />
                        <span className="span">Modèle</span> : PS5 Lecteur<br />
                        <span className="span">Pays de production</span> : European Union<br />
                        <span className="span">Poids (kg)</span> : 6<br />
                        <span className="span">Couleur</span> : blanc<br />
                        <span className="span">Matière principale</span> : plastic<br />
                        <br />
