    ...
    return (
        ...
        <div className="container SWIT body-2 bg-dark row">
            <div className="col-6 text-white ">
                    <img src="/pectures/cd-fortnite.jpg" className=" image2" width={"400px"} />
                    <Link to='/' className="link-icons" id="link-ic"><AiOutlineArrowLeft className="icons"/></Link>

            </div>
            <div className="col-6 text-white">
                <div className="ps-5 pt-5">
                    <h3 className="gamer-titre">The Definitive Guide to Fortnite 2023 </h3>
                    <div className="ps-3">
                    If you're a fan there's no better way to sharpen your skill than with this definitive guide.
                    Give yourself the upper hand and learn everything from the basics on<br/> gathering, building,
                    and surviving to how to navigate the map and pro survival tips.<br /><br/>
