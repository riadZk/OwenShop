    ...
    return (
        ...
        <div className="container SWIT body-2 bg-dark row">
            <div className="col-6 text-white ">
                    <img src="/pectures/clavier-gamer.png" className=" image2" width={"400px"} />
                    <Link to='/' className="link-icons" id="link-ic"><AiOutlineArrowLeft className="icons"/></Link>
            </div>
            <div className="col-6 text-white">
                <div className="ps-5 pt-5">
                    <h3 className="gamer-titre">Clavier-Gaming</h3>
                    <div className="ps-3">
                    Support Wired & Wireless Connection: DIERYA gaming keyboard connected via the included detachable USB-C braided cable, or unlock an easier connection via Bluetooth 5.1 and switch between 3 devices. You can use it on your computer, phone, or other devices.
                        <br />
