...
function Tshirt2() {
    ...
    let [img,setImage]=useState("/pectures/grosse-green2.jpg");
                ...
                <div className="ps-5 pt-5">
                    ...
                    <span className='span6COLOR' value="">Select a size : </span>
                        ...
                        <button className='span-color2 ' style={{
                            background:"#70879B"
                        }} onClick={()=>setImage(img="/pectures/grosse-gray.jpg")}></button>
                        <button className='span-color2' style={{
                            background:"#1E9658"
                        }} onClick={()=>setImage(img="/pectures/grosse-green.jpg")}></button>
                        <button className='span-color2 'style={{
                            background:"#C20329"
                        }} onClick={()=>setImage(img="/pectures/grosse-rouge.jpg")}></button>
                        <button className='span-color2'style={{
                            background:"white"
                        }} onClick={()=>setImage(img="/pectures/grosse-white2.jpg")}></button>
                        <button className='span-color2 bg-dark' 
                        onClick={()=>setImage(img="/pectures/grosse-green2.jpg")}></button>
                        <button className='span-color2'style={{
                            background:"#A2C4E4"
                        }} onClick={()=>setImage(img="/pectures/grosse-info.jpg")}></button>
                        <br/>
                        <br/>
