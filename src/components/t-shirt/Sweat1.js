...
function Sweat2() {
    ...
    let [img,setImage]=useState("/pectures/tonton-black.jpg");
    const plus = () => {
        setNumber(
            number = number + 1,
        )
                ...
                <div className="ps-5 pt-5">
                    ...
                    <span className='span6COLOR' value="">Select a size : </span>
                        ...
                        <button className='span-color2 ' style={{
                            background:"#212735"
                        }} onClick={()=>setImage(img="/pectures/tonton-blue.jpg")}></button>
                        <button className='span-color2' style={{
                            background:"#e2bc94"
                        }} onClick={()=>setImage(img="/pectures/tonton-2.jpg")}></button>
                        <button className='span-color2 'style={{
                            background:"#947564"
                        }} onClick={()=>setImage(img="/pectures/tonton-33.jpg")}></button>
                        <button className='span-color2'style={{
                            background:"#750033"
                        }} onClick={()=>setImage(img="/pectures/tonton-bordeau.jpg")}></button>
                        <button className='span-color2 bg-dark' onClick={()=>setImage(img="/pectures/tonton-black.jpg")}></button>
                        <button className='span-color2'style={{
                            background:"#CBCBCB"
                        }} onClick={()=>setImage(img="/pectures/tonton-gray.jpg")}></button>
                        <br/>
                        <br/>
